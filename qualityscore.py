...
im = cv2.imread("/home/sakshita/Desktop/test.png", 0) # read as gray scale
...
model = svmutil.svm_load_model("/home/sakshita/PycharmProjects/No-Reference-Image-Quality-Assessment-using-BRISQUE-Model/Python/allmodel")
